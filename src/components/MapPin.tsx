  ...
  return (
    <div className="relative z-10">
      <Transition
        ...
        leaveTo="opacity-0"
      >
        <div className="absolute z-50 bottom-12 -inset-x-24 w-60 h-24 bg-white rounded-md shadow-sm   p-4 gap-5 align-middle">
      ...
      <svg
        ...
        className="z-40 fill-[#6fab7d] hover:fill-slate-500 stroke-2 stroke-white"
        width="33"
        height="42"
        viewBox="0 0 30 38"
        fill="none"
